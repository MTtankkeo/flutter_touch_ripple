...
When defining the argument __eventCallBackableMinPercent__ of the above `TouchRippleBehavior` to be 1, we can implement a behavior to move the page after the touch ripple effect is complete.
