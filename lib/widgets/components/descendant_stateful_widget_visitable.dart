...
@protected
mixin DescendantStatefulWidgetVisitableMixin<WidgetType extends StatefulWidget,
    DescendantWidgetType extends StatefulWidget> on State<WidgetType> {
  (DescendantWidgetType, State<DescendantWidgetType>)? visitedDescendant;

  (DescendantWidgetType, State<DescendantWidgetType>)? _findByContext(
